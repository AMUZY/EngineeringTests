      ...
      <div className="mt-16 mb-32 px-auto flex flex-col lg:flex-row lg:justify-evenly w-full">
        ...
        <div className="w-full lg:w-[30%]">
          <div className="w-full">
            <h1 id="FAQ" className="nohighlight ttitle grey text-left">
              {" "}
              Contact Us{" "}
            </h1>
          </div>
          <div className="mt-8 w-full">
            ...
            <p className="tbase grey my-2">
              Please leave us a message using one of our social media platforms
              provided below :
            </p>
        ...
        <div className="w-full lg:w-[30%] flex flex-col justify-between items-start lg:items-center mt-12 lg:my-4">
          ...
          <Link
            className="my-2 grey tbase text-left lg:text-center underline hover:no-underline hover:text-[#FF6700]"
            href={"/"}
          >
            {" "}
            Home{" "}
        ...
        <div className="w-full lg:w-[30%] flex flex-col justify-between items-center mt-12 lg:my-4">
          <Image
            src="/assets/svgs/footerlogo.svg"
            width={86}
            height={86}
            alt="footer logo"
          />
          <p className="tsubtitle text-left lg:text-center grey my-2">
            EngineeringTests
          </p>
          <p className="tbase text-center lg:text-center grey my-2">
            Create, store and manage your engineering test results
          </p>
        </div>
      </div>
      {/* COPYRIGHT DIV */}
      <div className="mx-auto flex flex-col justify-center order-1 lg:order-2">
        <p className="tbase grey my-2 text-center">
          Copyright © 2023 EngineeringTests, Inc
        </p>
        <Link
          href={"/privacy"}
          className="tbase grey my-2 text-center underline hover:no-underline hover:text-[#FF6700]"
        >
          Privacy Policy
        </Link>
      </div>
