const svgstyle = "mr-0 lg:mr-2";
export const SVGS = {
  edit: (
    <svg
      className="unactive_svg"
      width="24"
      height="24"
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      />
      <path
        d="M11.89 5.05005C12.0996 6.3909 12.7486 7.62418 13.735 8.5563C14.7214 9.48841 15.9894 10.0666 17.34 10.2M3 22H21"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
  ...
  download_line: (
    ...
    >
      <path
        d="M9.31982 11.68L11.8798 14.24L14.4398 11.68M11.8798 4V14.17"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
  ...
  backarrow_black: (
    ...
    >
      <path
        d="M24.0625 31L10 21L24.0625 11M11.9531 21H40.4688"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  threedots: (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <circle cx="22" cy="11.5" r="1.5" fill="currentColor" />
      <circle cx="32" cy="11.5" r="1.5" fill="currentColor" />
      <circle cx="42" cy="11.5" r="1.5" fill="currentColor" />
    </svg>
  ),
  home_white: (
    <svg
